...
class Metric(Enum):
    ...
    absolute_average_fold_error = MetricInfo(
        fn=absolute_average_fold_error, direction=1, target_type="regression"
    )
    ...
    pr_auc = MetricInfo(
        fn=average_precision_score, direction="max", y_type="y_score", target_type="classification"
    )
    ...
    f1_macro = MetricInfo(
        fn=f1_score, kwargs={"average": "macro"}, direction="max", target_type="classification"
    )
    f1_micro = MetricInfo(
        fn=f1_score, kwargs={"average": "micro"}, direction="max", target_type="classification"
    )
